...
//	private final static org.slf4j.Logger LOGGER = LoggerFactory.getLogger(MediaUploadController.class);
//	@Autowired
...
//		String fileFolderPath = uploadPath + fileMd5.substring(0, 1) + "/" + fileMd5.substring(1) + "/" + fileMd5 + "/";
...
//		// 2、查询数据库文件是否存在
//		//MediaFile mediaFile = mediaFileMapper.findOne(fileMd5);
//		// 文件存在直接返回
//		if (file.exists() && mediaFile != null) {
//			ExceptionCast.cast(MediaCode.UPLOAD_FILE_REGISTER_EXIST);
//		}
//		boolean fileFold = createFileFold(fileMd5);
//		if (!fileFold) {
//			// 上传文件目录创建失败
//			ExceptionCast.cast(MediaCodeVo.UPLOAD_FILE_REGISTER_CREATEFOLDER_FAIL);
//		}
...
//		if (chunkFile.exists()) {
//			return new CheckChunkResultVo(MediaCode.CHUNK_FILE_EXIST_CHECK, true);
//		} else {
//			return new CheckChunkResultVo(MediaCode.CHUNK_FILE_EXIST_CHECK, false);
//		}
//	}
//	// 块文件上传
...
//		}
//		if (!newFile) {
//			ExceptionCast.cast(MediaCodeVo.MERGE_FILE_CREATEFAIL);
//		}
//		// 获取块文件，此列表是已经排好序的列表
...
//		if (mergeFile == null) {
//			ExceptionCast.cast(MediaCodeVo.MERGE_FILE_FAIL);
//		}
//		// 校验文件
//		boolean checkResult = this.checkFileMd5(mergeFile, fileMd5);
//		if (!checkResult) {
//			ExceptionCast.cast(MediaCodeVo.MERGE_FILE_CHECKFAIL);
//		}
//		// 将文件信息保存到数据库
...
//		// MediaFile save = mediaFileMapper.save(mediaFile);
